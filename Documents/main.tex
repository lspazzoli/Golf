...
\begin{document}
	...
	\section{Functional requirements and application design}
		...
		\textbf{Critical:}
			\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
				\item The system needs to be able to save that data in some way.
				\item There needs to be a way to have access to the web interface
				\item Must be able to handle max of at least 50 comcurrent users
				\item Web hosting server
			\end{list}
		\paragraph\indent
		\textbf{Important:}
		\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
			\item System must be lightweight
			\item Everyone has a basic
			\item Be able to download bibliography
			\item Android app
			\item Mobile website
			\item Must create profile manually
			\item No item should ever be deleted			
		\end{list}
		\paragraph\indent
		\textbf{Nice-to-have:}
		\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
			\item Show completion of paper in percentage
			\item Can link with Google Calender
			\item Every one has a basic profile
		\end{list}
