	...
	\section{Functional requirements and application design}
		...
		\textbf{Critical:}
			\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
				...
				access channel to the system as it makes it easier to access the system on a computer or non-Android device. If there is no web-server then there will be no web interface that can be accessed from research groups all over the country. This defeats the whole purpose of the system.
		...
		\subsection{Process specifications}
			\begin{itemize}
				...
				\end{figure}
				\begin{figure}
					\includegraphics[width=\linewidth]{Request.Paper.jpg}
