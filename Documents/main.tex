...
\begin{document}
	...
	\section{Functional requirements and application design}
		...
		\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}				
			...
			\item The system must be able to handle a max of at least 50 concurrent users as there is a possiblility that at least 50 users may access the system all at once. There will also be a maximum of at least 1000 users that use the system. The system must be able to handle that amount of users.
		\end{list}
		\paragraph\indent
		\textbf{Nice-to-have:}
		\begin{list}{$\bullet$}{\leftmargin=1.5cm \itemindent=0em}
